            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Detalhes do Contato</h2>
                        <a href="create.php" class="btn btn-success pull-right">Enviar</a>
                    </div>
                    <?php
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = $result->fetch()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='read.php?id=". $row['id'] ."' title='Exibir' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
